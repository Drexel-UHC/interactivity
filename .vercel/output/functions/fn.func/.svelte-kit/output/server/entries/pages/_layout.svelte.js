import { c as create_ssr_component, e as escape, d as add_attribute, f as compute_slots, a as subscribe, v as validate_component } from "../../chunks/index.js";
      ...
      return `
        ...
        trail: () => {
          return `${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})}
				<a class="btn btn-sm variant-ghost-surface" href="https://github.com/Drexel-UHC/interactivity" target="_blank" rel="noreferrer">GitHub
				</a>
			`;
        },
        lead: () => {
          return `<a href="/"><button type="button" class="btn btn-sm variant-filled">Home</button></a>

			`;
        },
        default: () => {
          return `<a href="/scrollies"><button type="button" class="btn btn-sm variant-filled">Scrolly Catalog</button></a>`;
        }
      })}
	`;
    },
